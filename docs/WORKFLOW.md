...
[Pull request #2](https://github.com/never-nude/worldbook2/pull/2) is merged and deployed at canonical main `e40ac198`. Runtime bytes and live reader navigation were verified after a successful Pages run; details are in VERIFICATION.md and PRODUCTION_INTEGRATION.md. Publication used the authenticated GitHub connector because the local Git CLI is not signed in. Other computers can fetch main. Legacy coastline glow remains follow-up work.
